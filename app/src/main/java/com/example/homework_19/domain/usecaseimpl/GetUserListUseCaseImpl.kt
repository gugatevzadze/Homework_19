...
class GetUserListUseCaseImpl @Inject constructor(private val userListRepository: UserListRepository) :
    GetUserListUseCase {
    override suspend fun execute(): Flow<Resource<List<UserEntity>>> {
